...
//     const { message, error } = useSelector(state => state.UserProfile);
            ...
            <div className={styles.card}>
                ...
                <form onSubmit={formik.handleSubmit} encType="multipart/form-data">
                    ...
                    <div className={styles.formGroup}>
                        ...
                        <div className={styles.passwordWrapper}>
                            <input
                                ...
                                maxLength={8}
                                className={`${styles.input} ${styles.passwordInput} ${formik.touched.password && formik.errors.password ? styles.inputError : ''}`}
                    ...
                    <div className={styles.formGroup}>
                        ...
                        <textarea
                            className={`${styles.textarea} ${formik.touched.address && formik.errors.address ? styles.inputError : ''}`}
                            {...formik.getFieldProps('address')}
                        />
                        {formik.touched.address && formik.errors.address && (
                            <div className={styles.errorText}>{formik.errors.address}</div>
                        )}
                    </div>
                    ...
                    {/* <div className={styles.formGroup}>
                        ...
                        <select className={styles.select} {...formik.getFieldProps('role')}>
                            <option value="user">User</option>
                        </select>
                    ...
                    <p className={styles.loginText}>
                        Already have an account?{" "}
                        <span className={styles.loginLink} onClick={() => navigate('/user-login')}>
                            Login
                        </span>
                    </p>
                </form>
